									...
									<div class="col-md-3">
										<div class="date" id="date1" data-target-input="nearest">
											<input type="text" class="form-control datetimepicker-input"
												...
												data-toggle="datetimepicker" name="availableDate" value=${availableDate}/>
										</div>
									</div>
		...
		<c:if test="${empty roomList}">
			<div class="container">
				<div class="text-center wow fadeInUp" data-wow-delay="0.1s">
					<h6 class="section-title text-center text-primary text-uppercase">No result</h6>
					<h1 class="mb-5">
						Explore Our <span class="text-primary text-uppercase"><a href="room-list.jsp">Rooms</a></span>
					</h1>
				</div>
		</c:if>
